<template>
	<div class="login-container">
		...
		<div class="login-box">
			...
			<el-form :model="form" :rules="rules" ref="registerForm" class="login-form" @keyup.enter.native="onRegister">
				...
				<el-form-item>
					<el-button class="submit-btn" type="primary" @click="onRegister" size="large" :loading="loading">注册</el-button>
				</el-form-item>
			</el-form>
			<div class="switch-tip">
				<span>已有账号？</span>
				<el-button variant="text" @click="goLogin" class="switch-btn">立即登录</el-button>
			</div>
		</div>
	</div>
</template>
...
const onRegister = async () => {
	...
	loading.value = true
	try {
		const res = await authApi.register(form.username, md5(form.password).toString())
